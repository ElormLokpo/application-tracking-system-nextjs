...
const buttonVariants = cva(
  "disabled:cursor-not-allowed disabled:dark:bg-stone-400 disabled:bg-stone-600",
  {
    variants: {
      variant: {
        ...
        google:
          "border-2 border-stone-900 dark:border-none  transition-colors duration-500 ease-out hover:bg-stone-100  dark:bg-stone-900 py-3.5 rounded-md text-xs  dark:hover:bg-stone-700 hover:cursor-pointer dark:text-white",
      },
    },
    defaultVariants: {
      variant: "default",
